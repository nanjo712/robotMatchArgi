...
#define RudderChassis_Front2Back (0.185f)           // (m)前后两轮的距离
#define RudderChassis_Left2Right (0.185f)           // 左右两轮的距离
...
#define STEER_WHEEL_MAX_SPEED (2500) // 线数/ms
#define STEER_WHEEL_MIN_SPEED (300)
#define DRIVE_WHEEL_MAX_SPEED (2.0)   // 驱动轮最大线速度m/s
#define DRIVE_WHEEL_MIN_SPEED (0.12)  // 低于此速度无法驱动
#define DRIVE_WHEEL_MIN_ERPM (500.0f)  // 低于此erpm无法驱动

#define MAX_ROTATE_VEL (9)           // 最大自转角速度rad/s
